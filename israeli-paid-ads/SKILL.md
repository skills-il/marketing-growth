...
- **Not mobile-dominated, despite the folklore**: Israeli web traffic is 48.76% mobile, 49.79% desktop, 1.45% tablet (StatCounter, August 2026). The widely repeated "over 70% mobile" figure does not hold for Israel. Still use vertical video for Meta and TikTok, where the audience is on phones, but do not deprioritise desktop landing-page quality or desktop bid adjustments on the strength of a 70% number, because about half your traffic is desktop.
