...
**הסכמה ופרטיות.** כברירת מחדל כדאי לשמור על תשובות NPS, CSAT ו-CES אנונימיות, זה גם מגן על המשיבים וגם מעלה את אחוז ההיענות. חוק הגנת הפרטיות תיקון 13 (בתוקף מאוגוסט 2025) מחייב הסכמה מפורשת וספציפית בכל מקרה שבו אפשר לקשר תשובה לאדם, אז לפני שמשתפים את הטופס צריך לבדוק אם הוא באמת אנונימי ולא רק נראה אנונימי:
