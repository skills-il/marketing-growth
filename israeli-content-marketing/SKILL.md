...
- Israeli web traffic is 48.76% mobile and 49.79% desktop (StatCounter, August 2026), not the "over 70% mobile" figure that circulates. Write for both screens: short paragraphs and scannable structure for phones, plus desktop considerations such as table layout and wider media, because about half the audience is on desktop. Agents commonly do one of two wrong things here: produce desktop-shaped walls of text, or over-correct and treat desktop as negligible.
