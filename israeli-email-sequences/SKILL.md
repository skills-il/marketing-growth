...
On top of Chok HaSpam, Amendment 13 to the Privacy Protection Law tightens marketing-data rules. Marketing email lists are a "database" subject to the law: you must (1) inform subjects at collection time why you collect data and who receives it, (2) honor erasure and access requests within 30 days, (3) appoint a Data Protection Officer where Amendment 13 requires one (the statutory triggers are their own test, NOT a 100k-subject headcount, so check the PPA's DPO guidance rather than assuming a threshold), (4) report serious security incidents to the Privacy Protection Authority. Two thresholds are commonly confused: a database whose purpose is supplying personal data to others as a business, INCLUDING direct-mail services, must register once it holds data on 10,000 people or more; separately, a database of specially-sensitive information on more than 100,000 people that is not subject to registration must notify the PPA within 30 days. Administrative fines under Amendment 13 are capped at 5% of annual turnover for severe violations. Apply both Chok HaSpam (consent + unsubscribe) AND Amendment 13 (data rights + breach reporting) when designing sequences.
